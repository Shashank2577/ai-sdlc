...
**Role:** developer · **Session:** <run URL> · **Spend:** <turns/tokens/wall-clock used of budget>

**Goal**

<One sentence, in the work item's terms. What was this session supposed to
produce?>
...
Include the command and its output that demonstrates it.>
...
- Nothing was deleted, force-pushed, or merged.
